...
/*		enquanto S for nao-vazio, faca:
*			remova uma aresta com peso minimo de S
*			se essa aresta conecta duas arvores diferentes, adicione-a a floresta, combinando duas arvores numa unica arvore parcial
*			do contrario, descarte a aresta
*/
